        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="col-12 text-right">
                    @if (auth()->user()->role == 1)
                        <a class="btn btn-primary" href="{{ route('admin.source-management.create') }}">add</i>&nbsp;&nbsp;<i
                                class="fa fa-user"></i></a>
                    @else
                        <a class="btn btn-primary" href="{{ route('system.source-management.create') }}">add</i>&nbsp;&nbsp;<i
                                class="fa fa-user"></i></a>
                    @endif
                </div>
                <div class="row">
                                        ...
                                        <tbody>
                                          ...
                                          <p class="text-xs text-secondary mb-0">{{ $row->subtown }}</p>
                                                    ...
                                                    <td class="align-middle">
                                                      @if (auth()->user()->role == 1)
                                                      <a href="{{ route('admin.source-management.edit', $row->id) }}"
                                                          class="font-weight-bold text-xs" data-toggle="tooltip"
                                                          data-original-title="Edit user">
                                                          Edit
                                                      </a>
                                                      @else
                                                      <a href="{{ route('system.source-management.edit', $row->id) }}"
                                                          class="font-weight-bold text-xs" data-toggle="tooltip"
                                                          data-original-title="Edit user">
                                                          Edit
                                                      </a>

        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body px-4 pb-2">
                    ...
                    @if (auth()->user()->role == 1)
                        <form role="form" method="POST" action="{{ route('admin.source-management.update', $source->id) }}"
                            enctype="multipart/form-data">
                        @else
                            <form role="form" method="POST" action="{{ route('system.source-management.update', $source->id) }}"
                                enctype="multipart/form-data">
                    @endif
                    @method('PUT')
                    @csrf
